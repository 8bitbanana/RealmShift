...
do
  ...
  local _base_0 = {
    init = function(self)
      ...
      return self.dialog:setTree(self.args.tree)
    end,
    update = function(self)
      self.dialog:update()
      ...
      if not self.dialog.running then
        return self.parent:dialogCallback()
      end
    end,
    draw = function(self)
